...
class ros_observer():
    ...
    def __init__(self, mpc_path, joint_topic = 'joint_states', est_pars = {}):
        ...
        self.v_tcp_pub = rospy.Publisher('tcp_vel', JointState, queue_size=1)  # publisher for tcp cartesian velocity
    ...
    def publish_contacts(self):
        for rob in self.robot:
            ...
            # publish the contact positions
            # http://docs.ros.org/en/api/visualization_msgs/html/msg/Marker.html
            # publish corresponding stiffness direction 
            # publish the corresponding force estimates
